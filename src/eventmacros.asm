...
.MACRO EVENT_UNKNOWN_C0A06C
	EVENT_CALLROUTINE MOVE_RELATIVE_BG3
.ENDMACRO
...
.MACRO EVENT_LOAD_ABS_X_Y_TABLE arg, arg2
	EVENT_CALLROUTINE LOAD_ABS_X_Y_TABLE, .LOBYTE(arg), .HIBYTE(arg), .LOBYTE(arg2), .HIBYTE(arg2)
.ENDMACRO
